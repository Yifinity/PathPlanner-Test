...
/*  NEED TO CHECK THIS
   * Reference:
   * https://pathplanner.dev/pplib-build-an-auto.html#load-an-auto
   */
    AutoBuilder.configureHolonomic(
      ...
      new HolonomicPathFollowerConfig(
        ...
        0.538815, // Drive base radius in meters. Distance from robot center to furthest module.
        new ReplanningConfig()
      ),
      () -> {
              // Copied from https://pathplanner.dev/pplib-getting-started.html#install-pathplannerlib
      ...
      this // Our subsystems to set requirements
    );  
  }
